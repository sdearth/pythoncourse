...
def print_hands(user, computer):
    print(f"  Your cards: {user}, current score: {sum(user)}")
    print(f"  Computer's first card: {dealer_hand[0]}")

clear = lambda: os.system('clear')

wants_to_play = input("Do you want to play a game of blackjack? Type 'y' or 'n': ") == 'y'
...
while wants_to_play:
    ...
    if dealer_score == 21:
        ...
        while sum(user_hand) <= 21 and wants_card():
    ...
    wants_to_play = input("Play again? Type 'y' or 'n': ") == 'y'
